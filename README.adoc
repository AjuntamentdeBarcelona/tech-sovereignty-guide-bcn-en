...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/tech-sovereignty-guide-bcn-en
//
// MANDATORY.
:_url: https://ethical-digital-standards-bcn.netlify.com/tech-sovereignty/
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Technological Sovereignty
//
...
:_summary: The implementation of technological sovereignty in the delivery of BCN City Council's digital services.
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: ethical digital standards, technology rights, barcelona, city council, technological sovereignty
//
