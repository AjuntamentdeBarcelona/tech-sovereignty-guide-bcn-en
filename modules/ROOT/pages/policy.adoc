...
Along these lines, the main elements of this policy, as defined in the xref:tech-practices:ROOT:aim-and-scope.adoc[Technology Code of Practice], can be seen below.
...
These principles are structured around the following guidelines set out in the xref:tech-practices:ROOT:aim-and-scope.adoc[Technology Code of Practice]:
